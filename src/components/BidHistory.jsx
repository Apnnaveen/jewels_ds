  ...
  useEffect(() => {
    const filtered = bidHistory.filter((item) => {
      ...
      const inDateRange = () => {
        ...
        const itemDate = new Date(item.journey_date);
      ...
      return (
        (!filters.booking_ref_id || match('booking_ref_id')) &&
        (!filters.biding_amount || match('biding_amount')) &&
        (!filters.journey_date || match('journey_date')) &&
        (!filters.from_address || match('from_address')) &&
        (!filters.to_address || match('to_address')) &&
        inDateRange()
      );
    });
