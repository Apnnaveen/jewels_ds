...
export async function loginUser(email, password) {
  const response = await fetch('http://jat-uk.com/api/users/driver_login', {
    method: 'POST',
    headers: {
...
export async function fetchAvailableJobs(driverId, token) {
  const response = await fetch(
    `http://jat-uk.com/api/users/available_jobs/${driverId}`,
    {
      headers: {
...
export async function getUserProfile(driverId, token) {
  const response = await fetch(`http://jat-uk.com/api/users/show_profile/${driverId}`, {
    method: 'GET',
    headers: {
      'Authorization': `Bearer ${token}`,
      'Content-Type': 'application/json',
...
export async function updatePassword(driverId, token, oldPassword, newPassword, confirmPassword) {
  const response = await fetch(`http://jat-uk.com/api/users/update_password/${driverId}`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${token}`,
...
export async function deleteAccount(driverId, token) {
  const response = await fetch(`http://jat-uk.com/api/users/delete_account/${driverId}`, {
    method: 'DELETE',
    headers: {
      'Authorization': `Bearer ${token}`,
      'Content-Type': 'application/json',
...
export async function getScheduledJobs(driverId, token) {
  const response = await fetch(`http://jat-uk.com/api/users/scheduled_journey_details/${driverId}`, {
    method: 'GET',
    headers: {
      'Authorization': `Bearer ${token}`,
      'Content-Type': 'application/json',
...
export async function fetchJourneyDetails(booking_journey_id, driverId, token) {
  ...
  const response = await fetch(
    `http://jat-uk.com/api/users/journeyDetails`,
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
export async function bidJob({ booking_journey_id, driver_id, email, fare, token }) {
  ...
  const response = await fetch('http://jat-uk.com/api/users/bid_job', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${token}`,
...
export async function changePasswordByForceStatus(email, newPassword, confirmPassword) {
  ...
  const response = await fetch('http://jat-uk.com/api/users/change_password_by_force_status', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
const response = await fetch(`http://jat-uk.com/api/users/bid_history/${driver_id}`, {
    method: 'GET',
    headers: {
      'Authorization': `Bearer ${token}`,
      'Content-Type': 'application/json',
...
export async function scheduled_journey_details(driver_id, token) {
  const response = await fetch(`http://jat-uk.com/api/users/scheduled_journey_details/${driver_id}`, {
      method: 'GET',
    headers: {
      'Authorization': `Bearer ${token}`,
      'Content-Type': 'application/json',
...
export async function upcoming_journey_details(driver_id, token) {
  const response = await fetch(`http://jat-uk.com/api/users/upcoming_journeys/${driver_id}`, {
      method: 'GET',
    headers: {
      'Authorization': `Bearer ${token}`,
      'Content-Type': 'application/json',
...
export async function tomorrow_journeys(driver_id, token) {
  const response = await fetch(`http://jat-uk.com/api/users/tomorrow_journeys/${driver_id}`, {
      method: 'GET',
    headers: {
      'Authorization': `Bearer ${token}`,
      'Content-Type': 'application/json',
...
export async function completed_journeys(driver_id, token) {
  const response = await fetch(`http://jat-uk.com/api/users/completed_journey_details/${driver_id}`, {
    method: 'GET',
    headers: {
      'Authorization': `Bearer ${token}`,
      'Content-Type': 'application/json',
